...
function updatePopup() {
  ...
  function deselectSeat(targetRow, targetCol) {
    ...
    console.log(`Deselected seat: Row ${targetRow} Col ${targetCol}`);
  }
  ...
  seats.forEach(seat => {
    seat.addEventListener('click', function () {
      ...
      console.log(`Clicked seat: Row ${row}, Col ${col}, Zone ${zone}`);
      ...
      if (exists) {
        ...
        console.log(`Selected seat: Row ${row}, Col ${col}, Zone ${zone}`);
      }
      updatePopup();
    });
  });
